...
var mainWindow, mainWindowwidthDefault, mainWindowheightDefault,
		...
		pin, lock, stopWatchState, mistake, tankHelpShow, facebookChat, temperatureTimer, secondHand,
		secondShadow, startButton, stopButton, helpButton, actionSwitch, letterBack, updatetemperature,
...
function setmenu() {
	mainWindow.onContextMenu = function () {
		...
		items.push(mItem);
	  	...
	  	mItem = new MenuItem();
	  	mItem.title = "Panzer Temperature Gauge Help";
	  	mItem.onSelect = function () {
		  	tankHelpShow();
	  	};
		items.push(mItem);
...
function settooltip() {
	...
	if (preferences.tooltipPref.value === "enabled") {
        dangerLamp.tooltip = "The over-temperature lamp";
        OHMLamp.tooltip = "The OHM indicator lamp";
		startButton.tooltip = "Press to restart the gauge";
		stopButton.tooltip = "Press to switch off gauge functions";
		switchFacesButton.tooltip = "Press to toggle fahrenheit or centigrade";
