...
/*property
    ...
    hRegistrationPoint, height, identifier, indexOf, interval, isNaN,
    itemExists, kEaseOut, keyCode, length, max, maxLength, milliseconds,
    minLength, name, onKeyDown, onMouseDown, onMouseUp, onMouseWheel,
    onPreferencesChanged, onTimerFired, onWakeFromSleep, onload, opacity,
    parse, platform, random, readFile, rotation, round, sampleIntervalPref,
    scaleSwitchPref, scrollDelta, size, soundPref, src, srcHeight, srcWidth,
    start, startAngle, startTime, ticking, ticks, tooltip, vOffset,
    vRegistrationPoint, value, visible, volumes, width
*/
...
function updatetemperature() {
    ...
    tempDigitalMaxTextArea.data = cpuMax[sensorCounter] || "00";
    tempDigitalCurrText.data =  cpuTemp[sensorCounter];
    tempDigitalMaxText.data = cpuMax[sensorCounter] || "00";
